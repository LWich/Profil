...
const ParseSettingsTable = () => {
  ...
  const [currentPage, setCurrentPage] = useState(apiEndpoints['parse_settings']);
  ...
  return (
    <div className="container mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4">Table: Parse Settings</h2>
...
export default ParseSettingsTable;